...
public class MenuForm extends javax.swing.JFrame {
    ...
    private IFiltrarPaginado paginado;
    ...
    public MenuForm() {
        ...
        this.paginado = new FiltrarPaginado();
    ...
    private void initComponents() {
        ...
        jPanel1.add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 30, 600, 70));
    ...
    private void cargarLibros() {
         ...
         */
        try {
            this.totalPaginas = (int) Math.ceil((double) this.paginado.listaLibros().size() / this.LIMITE);
            ...
            int endIndex = Math.min(startIndex + this.LIMITE, this.paginado.listaLibros().size());

            // Obtener la sublista de libros para esta página
            List<LibroDTO> libroLista = this.paginado.listaLibros().subList(startIndex, endIndex);
