...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titulo.setText("Recomendaciones para ti");
    ...
    private void cargarLibros() {
        /*try {
            List<LibroDTO> libroLista = this.libros.paginadoLibros(this.LIMITE, this.pagina);
         ...
         */
        try {
            this.totalPaginas = (int) Math.ceil((double) this.libros.listaLibros().size() / this.LIMITE);
            // Calcular el índice inicial del libro para esta página
            int startIndex = this.pagina * this.LIMITE;

            // Calcular el índice final del libro para esta página
            int endIndex = Math.min(startIndex + this.LIMITE, this.libros.listaLibros().size());

            // Obtener la sublista de libros para esta página
            List<LibroDTO> libroLista = this.libros.listaLibros().subList(startIndex, endIndex);
    ...
    private void verificarBotonesNavegacion() {
        ...
        btnSiguiente.setEnabled(this.pagina < this.totalPaginas - 1);
