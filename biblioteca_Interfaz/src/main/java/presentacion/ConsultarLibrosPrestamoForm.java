 ...
 * @author Usuario
 */
public class ConsultarLibrosPrestamoForm extends javax.swing.JFrame {

    private IHistorialLibrosService prestamoLibros;

    public ConsultarLibrosPrestamoForm() {
        initComponents();
        metodosIniciales();
        this.prestamoLibros = new HistorialFiltrarLibros();
        llenarTabla();
        setSize(840, 600);
        setResizable(false);
        iniciarFiltros();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Prestamos por Libro");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, 510, -1));
    ...
    private void llenarTabla() {
        ...
        try {
            List<TablaLibroDTO> lislalibros = prestamoLibros.TablaLibros();
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (filaSeleccionada != -1) {
                String isbn = (String) tablaLibros.getValueAt(filaSeleccionada, 0);
                    ...
                    ConsultarPrestamosLibrosForm consultar = new ConsultarPrestamosLibrosForm();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarLibrosPrestamoForm.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarLibrosPrestamoForm().setVisible(true);
            }
        });
    }
